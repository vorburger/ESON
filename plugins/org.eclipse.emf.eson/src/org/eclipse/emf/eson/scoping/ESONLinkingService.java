...
public class ESONLinkingService extends DefaultLinkingService {
	...
	// TODO Propose to Xtext to factor out re-usable code not related to xtext.xtext but of interest to any langs dealing with EPackage?
	// perhaps into a new class AbstractEPackageLinkingService extends DefaultLinkingService
	// @see https://bugs.eclipse.org/bugs/show_bug.cgi?id=489748

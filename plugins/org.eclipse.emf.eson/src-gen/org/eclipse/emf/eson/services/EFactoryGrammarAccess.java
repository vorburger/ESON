...
public class EFactoryGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FactoryElements extends AbstractParserRuleElementFinder {
		...
		//Factory:
		//	imports+=NamespaceImport* epackages+=PackageImport* //	(annotations+=Annotation)*
		//	root=NewObject;
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		...
		////Annotation:
		////	CustomNameMapping;
		//// 2015-02-20 COMMENTED OUT, as this never really fully worked anyway; while ModelBuilder would respect this in setName(), EFactoryQualifiedNameProvider would not and index based on hard-coded 'name' only, anyway, so for working cross references this never wasn't sufficiently completely implemented, thus better commented out, for now
